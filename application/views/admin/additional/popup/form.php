            ...
            <div class="intro-y box">
                ...
                <div id="input" class="p-5">
                    <div class="preview">
                        ...
                        <?= isset($input->tipe) ? form_hidden('tipe', 2) : '' ?>
                        <div>
                            <label for="name" class="form-label">Popup Name</label>
                        ...
                        <div class="mt-3">
                            ...
                            <?php endif ?>
                            <?php if ($input->image): ?>
                                <img src="<?= base_url("https://files.pools.systems/popup/$input->image") ?>" alt="" height="150">
                            <?php endif ?>
                        </div>
                        <div class="mt-3">
